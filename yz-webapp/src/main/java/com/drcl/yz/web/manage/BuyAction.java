...
import com.drcl.yz.core.BuyManager;
 ...
 */
@Namespace("/backend")
@Results( { @Result(name = CrudActionSupport.RELOAD, location = "buy.action?mtype=${mtype}", type = "redirect") })
public class BuyAction extends CrudActionSupport<Buy>
{
    ...
    public void setEntity(Buy entity)
    {
        this.entity = entity;
    }
