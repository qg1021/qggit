        ...
        implements BusinessDao
{
     ...
     * 
     * @since 2012-7-26
     * @see com.drcl.yz.api.BusinessDao#batchDelete(java.util.List)
     */
    @Override
     ...
     * 
     * @since 2012-7-26
     * @see com.drcl.yz.api.BusinessDao#publish(java.util.List,
     *      java.lang.Boolean)
     */
    @Override
    public void publish(List<Long> ids, Boolean isPublish)
    {
        String hql = "update Business set ispublish = :ispublish , publishdate = :publishdate where id in(:ids)";
