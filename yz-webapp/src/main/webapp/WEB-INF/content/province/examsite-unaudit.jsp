		...
		<div class="right_content">
			...
			<div class="pagehead01"></div>
				<ul class="switch_tab mb10">
					...
					<li id='tab2' class="switch_tab_current" >待审核考点</li>
					<li id='tab3' onclick="location.href='examsite!search.action'">考点审核记录</li>   
				</ul>
				<form id="mainForm" action="examsite!searchUnAudit.action" method="post">
	    			...
	    			<table class="tablebox">
	    				...
	    				<s:iterator value="page.result" status="st">
						   <tr>
						        ...
						        <td>
						        	<a href="examsite!view.action?id=${id}&returnType=view">审核考点</a>
						        </td>
						    </tr>
					    </s:iterator>
