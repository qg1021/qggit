...
<body>
	...
	<div class="layer_box">
		报考记录：<input type="file" id="file" name="file" onchange="uploadArrange('../upload!record.excsec');"/><a target="_blank" href="../templatedownload.excsec?name=student.xlsx">模板</a>
  	</div>
    <!--浮动层 end --> 
</body>
</html>