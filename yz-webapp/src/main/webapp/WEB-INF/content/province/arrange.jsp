...
<div id="wrapper">
	...
	<div id="content">  
		...
		<div class="right_content">
			...
			<form id="mainForm" action="arrange.action" method="post">
	    		<div class="top_serach_box_registration">
			        ...
			        <ul>
			            ...
			            <li>
			                <label>考次状态</label>
			                 <s:select list="#{'2':'已发布','3':'已排考','4':'待考','5':'考试中','6':'已考'}"  id="status" name="filter_EQI_status"  value="#request.status" cssStyle="width:85px;" headerKey="" headerValue="--所有--"/>
			            </li>
	    			...
	    			<table class="tablebox"  >
	    				...
	    				<s:iterator value="page.result" status="st">
						    <tr>
							    ...
							    <td>${statusName}</td>
							    <td>
								    <a href="examrecord.action?timesid=${id}">排考管理</a>
							    </td>
						    </tr>
					    </s:iterator>
